const features = [
  ...
  },
  {
    ...
    description: "Structured JSON in production, pretty console in dev, with sensitive-key redaction.",
  },
  {
    icon: "◈",
    title: "Rate Limiting",
  ...
  },
  {
    ...
    description: "Environment variables validated at startup with Zod. Fail fast on misconfiguration.",
  },
];
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-px sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            ...
            >
              <span className="mb-5 block text-2xl text-white/10 transition-colors group-hover:text-white/20">
                {feature.icon}
              </span>
